...
public:	
	...
	*/
	Material( std::string & name, const vec3f & ambient, const vec3f & diffuse,
...
public:
	vec3f ambient; /*!< RGB barva prostøedí \f$\left<0, 1\right>^3\f$. */
	vec3f diffuse; /*!< RGB barva rozptylu \f$\left<0, 1\right>^3\f$. */
	vec3f specular; /*!< RGB barva odrazu \f$\left<0, 1\right>^3\f$. */

	vec3f emission; /*!< RGB barva emise \f$\left<0, 1\right>^3\f$. */
